...
void KeyHandler::handleMouseEvent(SDL_MouseButtonEvent event) {
    switch (event.type) {
        ...
        case SDL_MOUSEBUTTONUP:
            ...
            notifyOnMouseClickEvent(event.button, Vector2I{event.x, event.y});
            break;
    }
}
...
void KeyHandler::bindOnMouseClickEvent(std::function<void(Vector2I position)> event, int keyCode) {
...
void KeyHandler::notifyOnMouseClickEvent(int keyCode, Vector2I position) {
