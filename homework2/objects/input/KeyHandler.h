...
struct MouseEvent {
    std::function<void(Vector2I position)> event;
    int keyCode;
};
...
public:
    ...
    void bindOnMouseClickEvent(std::function<void(Vector2I position)> event, int keyCode);
...
private:
    ...
    void notifyOnMouseClickEvent(int keyCode, Vector2I position);
};
